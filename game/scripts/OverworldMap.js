...
window.OverworldMaps = {
  DemoRoom: {
    id: "DemoRoom",
    lowerSrc: "/game/images/maps/demoL.png",
    upperSrc: "/game/images/maps/demoU.png",
    configObjects: {
      player: {
        type: "Person",
      ...
      sans: {
        ...
        x: utils.withGrid(10),
        y: utils.withGrid(8),
        src: "/game/images/characters/sans.png",
        behaviorLoop: [
        ...
        talking: [
          {
            required: ["OPEN_ALBUM"],
            events: [
              { type: "textMessage", text: "so what did you think? shout-out to dimden for the code ;)", facePlayer: "sans" },
            ]
          },
          {
            events: [
              { type: "textMessage", text: "just go check the album", facePlayer: "sans" },
      ...
      notebook: {
        ...
        x: utils.withGrid(16),
        y: utils.withGrid(11),
        src: "/game/images/blank.png",
        talking: [
          {
            events: [
              { type: "textMessage", text: "You opened up the album." },
              { type: "addStoryFlag", flag: "OPEN_ALBUM" },
              { type: "album"}
            ]
          }
        ]
      ...
      samara: {
        ...
        x: utils.withGrid(6),
        y: utils.withGrid(18),
        src: "/game/images/characters/mari.png",
        talking: [
          {
            events: [
              { type: "textMessage", text: "Oi meu nome é Samara, tenho 14 anos (Teria se estivesse viva), morri aos 13 em Cascavel-PR." },
              { type: "textMessage", text: "Eu andava de bicicleta Quando não pude desviar de um arame farpado." },
              { type: "textMessage", text: "O pior foi que o dono do lote não quis me ajudar," },
              { type: "textMessage", text: "riu bastante mim após agonizar por 2 horas enroscada no arame eu faleci," },
              { type: "textMessage", text: "através dessa mensagem eu peço que façam com que eu possa descançar em paz." },
              { type: "textMessage", text: "Envie isso para 20 comunidades e minha alma estara sendo salva por você e pelos outros 20 que receberão." },
              { type: "textMessage", text: "Caso não repasse essa mensagem vou visitar-lhe hoje a noite" },
              { type: "textMessage", text: "assim vc poderá conhecer o tal arame bem de pertinho." },
              { type: "textMessage", text: "Dia 15 de Julho Mariana resolveu rir dessa mensagem, uma noite depois ela sumiu sem deixar vestigios." },
              { type: "textMessage", text: "O mesmo aconteceu com Kare dia 18 de Outubro." },
              { type: "textMessage", text: "Não Quebre essa corrente por favor, a não ser que queira sentir a minha presença." }
            ]
          }
        ]
      },
  ...
  Neighbour: {
    id: "Neighbour",
    lowerSrc: "/game/images/maps/neighbour.png",
    upperSrc: "",
    configObjects: {
      player: {
        type: "Person",
      ...
      caitlyn: {
        ...
        x: utils.withGrid(11),
        y: utils.withGrid(15),
        src: "/game/images/characters/caitlyn.png",
        behaviorLoop: [
          { type: "walk", direction: "left", },
          { type: "walk", direction: "down", },
          { type: "walk", direction: "right", },
        ...
        talking: [
          {
            events: [
              ...
              { type: "textMessage", text: "There's nothing to watch yet." },
  ...
  Bathroom: {
    id: "Bathroom",
    lowerSrc: "/game/images/maps/bathroom.png",
    upperSrc: "",
    configObjects: {
      player: {
        type: "Person",
      ...
      oneko: {
        ...
        x: utils.withGrid(0),
        y: utils.withGrid(0),
        src: "/game/images/characters/oneko.png",
        behaviorLoop: [
          { type: "walk", direction: "right", },
